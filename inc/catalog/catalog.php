			...
			<div class="col-md-7">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-md-4"><small>&nbsp;<br></small>
						 <button type="button" class="btn btn-primary btn-lg btn-rounded" id="facebook-test"><i class="fa fa-shopping-basket"></i> ADD TO CART</button>
						 <fb:login-button 
...
$('#facebook-test').on('click', function(){
