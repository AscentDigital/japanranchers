...
if ( $order ) : ?>
	...
	<?php else : ?>
		<div class="row">
			<div class="col-md-8">
				<h3>
					<span class="woocommerce-thankyou-order-received text-primary"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', __( 'Thank you. Your order has been received.', 'woocommerce' ), $order ); ?></span>
				</h3>
			</div>
		</div>
		<br>
